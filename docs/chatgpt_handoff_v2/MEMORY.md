...
- [project_puct_attempts.md](project_puct_attempts.md) — PUCT ABANDONED, replaced with maximin. ChatGPT Pro diagnosed root causes.
...
- [project_distill03_status.md](project_distill03_status.md) — C bot WORKING: maximin search, eval fixes, climbing Silver from 529th
